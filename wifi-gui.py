...
from PyQt5.QtGui import QTextCursor, QPalette, QColor # Add QPalette, QColor to the import
from PyQt5.QtCore import Qt, QProcess, pyqtSignal, QObject # Make sure Qt is imported
...
class WiFiToolGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        refresh_btn.setStyleSheet("background-color: #3498db; color: black; font-weight: bold; padding: 8px;")
        ...
        self.interface_combo.setStyleSheet("background-color: #2c3e50; color: black; padding: 5px;")
        ...
        self.output_console.setStyleSheet("background-color: #2c3e10; color: #20f508; font-family: monospace;")
        ...
        self.stop_scan_btn.setStyleSheet("background-color: #c0392b; color: black; font-weight: bold; padding: 5px;")
        self.stop_scan_btn.hide()
        
        self.stop_wash_btn = QPushButton("Stop WPS Scan")
        self.stop_wash_btn.clicked.connect(self.stop_wash)
        self.stop_wash_btn.setStyleSheet("background-color: #c0392b; color: black; font-weight: bold; padding: 5px;")
    ...
    def create_mode_buttons(self, layout):
        ...
        for text, slot in buttons:
            ...
            btn.setStyleSheet("background-color: #e74c3c; color: black; font-weight: bold; padding: 8px;")
    ...
    def create_tool_buttons(self, layout):
        ...
        for text, slot in buttons:
            btn = QPushButton(text)
            btn.clicked.connect(slot)
            btn.setStyleSheet("background-color: #2ecc71; color: black; font-weight: bold; padding: 8px;")
            group_layout.addWidget(btn)
    ...
    def create_utility_buttons(self, layout):
        ...
        for text, slot in buttons:
            btn = QPushButton(text)
            btn.clicked.connect(slot)
            btn.setStyleSheet("background-color: #f39c12; color: black; font-weight: bold; padding: 8px;")
            group_layout.addWidget(btn)
        ...
        exit_btn.setStyleSheet("background-color: #c0392b; color: black; font-weight: bold; padding: 8px;")
...
def main():
    ...
    # --- ADD THIS SECTION TO FORCE DARK THEME ---
    # Force the application to use the Fusion style (a modern, widget-style)
    app.setStyle('Fusion')
